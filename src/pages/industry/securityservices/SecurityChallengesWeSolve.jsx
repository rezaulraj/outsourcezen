...
const challenges = [
  {
    title: "Unreliable Security Coverage",
    problem:
      "Sites often face missed shifts, weak attendance, late patrols and inconsistent guard performance.",
    solution:
      "We help employers hire dependable guards, patrol officers and supervisors for continuous site coverage.",
    icon: UsersRound,
    color: "#FFE994",
    alert: "Coverage Gap",
    fixed: "Site Covered",
  ...
  {
    title: "CCTV Monitoring Gaps",
    problem:
      "Control rooms need alert operators who can monitor cameras, detect incidents and report quickly.",
    solution:
      "We recruit CCTV operators, control room staff and monitoring teams for active surveillance coverage.",
    icon: Camera,
    color: "#CFF7BC",
    alert: "Blind Spot",
    fixed: "CCTV Online",
  },
  {
    ...
    problem:
      "Poor gate control can create visitor, vehicle and unauthorized entry risks for buildings and sites.",
    solution:
      "We provide access control officers, gate security and reception security staff for safer entry points.",
    icon: Fingerprint,
    color: "#A6E6EC",
    alert: "Entry Risk",
    fixed: "Access Secured",
  },
  {
    title: "Event & Crowd Pressure",
    problem:
      "Events, hotels, malls and public spaces require trained staff for crowd flow and incident response.",
    solution:
      "We support event security, crowd control, VIP protection and venue security recruitment.",
    icon: Siren,
    color: "#FFF6C8",
    alert: "Crowd Risk",
    fixed: "Event Covered",
  ...
  {
    title: "Compliance & Training Needs",
    problem:
      "Employers need guards who understand reporting, safety procedures, emergency action and site rules.",
    solution:
      "We screen candidates for training readiness, discipline, communication and compliance awareness.",
    icon: ClipboardCheck,
    color: "#FFE1A6",
    alert: "Training Gap",
  ...
  {
    title: "24/7 Site Protection",
    problem:
      "Warehouses, factories, offices and residential sites often need day-night security rotation.",
    solution:
      "We support shift-based security hiring for round-the-clock protection and replacement coverage.",
    icon: Clock3,
    color: "#CFF7BC",
    alert: "Shift Gap",
    fixed: "24/7 Covered",
...
const SecurityChallengesWeSolve = () => {
  ...
  useEffect(() => {
    ...
    const drawChallengeFlow = () => {
      const points = [
        { x: w * 0.15, y: h * 0.28, label: "RISK", color: "#FFE994" },
        { x: w * 0.32, y: h * 0.42, label: "SOURCE", color: "#CFF7BC" },
        { x: w * 0.5, y: h * 0.32, label: "VERIFY", color: "#A6E6EC" },
        { x: w * 0.68, y: h * 0.43, label: "TRAIN", color: "#FFF6C8" },
        { x: w * 0.85, y: h * 0.3, label: "SECURE", color: "#FFE994" },
      ];
    ...
    const drawDashboard = () => {
      ...
      ctx.textAlign = "center";
      ctx.fillText(solved ? "SOLUTION ACTIVE" : "SECURITY CHALLENGE", 32, -14);
    ...
    const drawSolutionPanel = (x, y) => {
      ...
      ctx.font = "900 13px Arimo";
      ctx.textAlign = "center";
      ctx.fillText("SITE COVERAGE", 0, -27);

      ["Guards", "CCTV", "Access"].forEach((item, i) => {
        const yy = 2 + i * 24;
    ...
    const draw = () => {
      ...
      drawSolutionPanel(w * 0.77, h * 0.55);

      drawFloatingCard(w * 0.22, h * 0.68, "Risk", "Detected", "#FFE994", 0);
      drawFloatingCard(w * 0.78, h * 0.68, "Coverage", "Active", "#CFF7BC", 2);
      drawFloatingCard(
        w * 0.5,
        h * 0.96,
        "Outcome",
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="security-ch-reveal mx-auto mb-14 max-w-3xl text-center">
          <p className="mb-3 inline-block border-b border-black text-sm font-medium text-black">
            Security Challenges We Solve
          </p>

          <h2 className="text-4xl font-normal tracking-[-0.045em] text-black sm:text-5xl lg:text-6xl">
            {["Solving", "security", "workforce", "gaps", "smoothly"].map(
              (word) => (
                <span key={word} className="inline-block overflow-hidden px-1">
                  <span className="security-ch-word inline-block">{word}</span>
                </span>
              ),
            )}
          </h2>
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-6 text-black/70">
            We help employers solve guard shortages, CCTV monitoring gaps,
            access control risks, event pressure, compliance needs and 24/7
            security coverage.
          </p>
        </div>
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            {challenges.map(({ icon: Icon, ...item }, index) => {
              ...
              return (
                <button
                  ...
                  className={`security-ch-card w-full rounded-[30px] border p-6 text-left transition-all duration-300 ${
                    isActive
                  ...
                  <div className="flex gap-5">
                    ...
                    <div>
                      ...
                      <div className="mt-4 grid gap-3">
                        <div>
                          <p className="text-xs font-bold uppercase tracking-[0.16em] text-black/70">
                            Problem
                          </p>
          ...
          <div className="security-ch-reveal relative h-[500px] overflow-hidden rounded-[40px] border border-black/10 bg-[#FFF9E6] shadow-xl sm:h-[600px] lg:sticky lg:top-24 lg:h-[720px]">
        ...
        {/* <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((item) => (
            <article
              key={item.label}
              className="security-ch-stat rounded-[28px] border border-black/10 bg-[#FFF9E6] p-6 text-center"
            >
        ...
        <div className="security-ch-reveal mt-10 rounded-[34px] border border-black/10 bg-[#FFF9E6] p-6 sm:p-8">
            ...
            <div className="flex gap-5">
              ...
              <div>
                <h3 className="text-2xl font-bold tracking-[-0.04em] text-black">
                  Ready to solve your security staffing challenges?
                </h3>

                <p className="mt-2 max-w-2xl text-sm leading-6 text-black/70">
                  We support offices, warehouses, retail stores, hotels,
                  construction sites, residential properties, events and control
                  rooms with reliable security recruitment.
                </p>
              </div>
            </div>
        ...
        <div className="security-ch-reveal mt-6 flex flex-wrap items-center justify-center gap-3">
          {[
            "Guard shortage",
            "CCTV gaps",
            "Access control",
...
export default SecurityChallengesWeSolve;
